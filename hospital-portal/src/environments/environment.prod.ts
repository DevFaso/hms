...
export const environment = {
  ...
  // provisioned 2026-05-07). Stays disabled until UAT soak completes
  // and Phase 3 cutover per docs/tasks-keycloak.md §KC-4.
  oidc: {
    enabled: false,
    issuer: 'https://hms-keycloak-prod-prod.up.railway.app/realms/hms',
    clientId: 'hms-portal',
    redirectUri: 'https://hms.bitnesttechs.com/login',
    postLogoutRedirectUri: 'https://hms.bitnesttechs.com/login',
