  ...
  private readonly baseNavItems = computed<NavItem[]>(() => {
    ...
    if (this.auth.hasAnyRole(['ROLE_PATIENT'])) {
      return [
        ...
        { icon: 'biotech', label: 'Lab Orders', route: '/my-lab-orders' },
        { icon: 'radiology', label: 'Imaging Orders', route: '/my-imaging-orders' },
        { icon: 'local_pharmacy', label: 'Pharmacy Fills', route: '/my-pharmacy-fills' },
        { icon: 'surgical', label: 'Procedures', route: '/my-procedures' },
        { icon: 'local_hospital', label: 'Admissions', route: '/my-admissions' },
        { icon: 'school', label: 'My Education', route: '/my-education-progress' },
        { icon: 'menu_book', label: 'Education Library', route: '/my-education-browse' },
        { icon: 'download', label: 'Download Records', route: '/my-records-download' },
        { icon: 'show_chart', label: 'Lab Trends', route: '/my-lab-trends' },
        { icon: 'login', label: 'Check In', route: '/my-checkin' },
        { icon: 'assignment', label: 'Treatment Plans', route: '/my-treatment-plans' },
        { icon: 'swap_horiz', label: 'Referrals', route: '/my-referrals' },
        { icon: 'groups', label: 'Consultations', route: '/my-consultations' },
        { icon: 'assignment', label: 'Questionnaires', route: '/my-questionnaires' },
        { icon: 'health_and_safety', label: 'Health Reminders', route: '/my-reminders' },
        { icon: 'monitor_heart', label: 'My Outcomes', route: '/my-outcomes' },
        { icon: 'supervised_user_circle', label: 'Care Team', route: '/my-care-team' },
        { icon: 'family_restroom', label: 'Family Access', route: '/my-family-access' },
