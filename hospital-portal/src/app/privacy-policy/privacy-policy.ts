        ...
        @if (lang === 'en') {
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Biometric authentication status (fingerprint/face; biometric data is stored
                on-device only and never transmitted to our servers)
              </li>
            </ul>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <strong>Inter-hospital sharing:</strong> Only when you grant explicit consent
                through our consent management feature
              </li>
              <li>
                <strong>Service providers:</strong> Trusted third parties that assist in operating
                the Service (hosting, infrastructure), bound by confidentiality agreements
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              or as needed to provide the Service. Medical records are retained in accordance with
        ...
        @if (lang === 'fr') {
          ...
          <section>
            ...
            <p>
              ...
              de Confidentialité explique comment nous collectons, utilisons, divulguons et
              protégeons vos informations personnelles et de santé lorsque vous utilisez notre
              Service.
            </p>
            <p>
              En utilisant le Service, vous acceptez la collecte et l'utilisation des informations
              conformément à cette politique. Si vous n'êtes pas d'accord, veuillez ne pas utiliser
              le Service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                Photos et documents que vous téléchargez (ex. : cartes d'assurance, documents
                médicaux)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Nous ne vendons pas vos informations personnelles ou de santé. Nous pouvons partager
              des données avec :
            </p>
            <ul>
              <li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Face ID &amp; Touch ID / AndroidX Biometric &mdash; authentification biométrique
              </li>
            </ul>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              jour » en haut de cette page. L'utilisation continue du Service après les
              modifications constitue une acceptation de la politique mise à jour.
            </p>
          </section>
