 ...
 * an empty list — there is no auto-merge or auto-link behaviour even
 * when the flag is on; the foundation pass returns ranked candidates
 * for the receptionist UI to review.
 *
