...
public class LabTestDefinitionApprovalRequestDTO {
     ...
     * Allowed values:
     * - SUBMIT_FOR_QA          (LAB_SCIENTIST, LAB_MANAGER, LAB_DIRECTOR, SUPER_ADMIN — DRAFT → PENDING_QA_REVIEW)
     * - COMPLETE_QA_REVIEW     (QUALITY_MANAGER, LAB_DIRECTOR, SUPER_ADMIN — PENDING_QA_REVIEW → PENDING_DIRECTOR_APPROVAL)
