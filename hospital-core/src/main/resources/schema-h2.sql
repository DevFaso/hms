...
CREATE TABLE IF NOT EXISTS clinical.prescriptions (
	...
	medication_code VARCHAR2(64),
	medication_display_name VARCHAR2(255),
	dosage VARCHAR2(100),
	dose_unit VARCHAR2(40),
	route VARCHAR2(80),
	frequency VARCHAR2(100),
	duration VARCHAR2(100),
	quantity NUMERIC(12, 2),
	quantity_unit VARCHAR2(60),
	...
	pharmacy_npi VARCHAR2(50),
	pharmacy_contact VARCHAR2(120),
	pharmacy_address VARCHAR2(255),
	dispatch_channel VARCHAR2(40),
	dispatch_status VARCHAR2(40),
	dispatch_reference VARCHAR2(120),
	...
	override_reason VARCHAR2(1024),
	two_factor_method VARCHAR2(40),
	two_factor_reference VARCHAR2(120),
...
CREATE TABLE IF NOT EXISTS clinical.prescription_instructions (
	...
	label VARCHAR2(120),
	instruction_text VARCHAR2(1024),
	education_url VARCHAR2(512),
...
CREATE TABLE IF NOT EXISTS clinical.prescription_alerts (
	...
	alert_type VARCHAR2(40),
	severity VARCHAR2(20),
	message TEXT,
	reference_code VARCHAR2(120),
...
CREATE TABLE IF NOT EXISTS clinical.prescription_transmissions (
	...
	destination_reference VARCHAR2(120),
	status VARCHAR2(40),
	status_reason TEXT,
...
CREATE TABLE IF NOT EXISTS clinical.treatment_plans (
	...
	sign_off_by UUID,
	status VARCHAR2(40) NOT NULL DEFAULT 'DRAFT',
...
CREATE TABLE IF NOT EXISTS clinical.treatment_plan_followups (
	...
	status VARCHAR2(40) NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE IF NOT EXISTS empi.master_identities (
	id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
	empi_number VARCHAR2(64) NOT NULL UNIQUE,
	patient_id UUID,
	organization_id UUID,
	hospital_id UUID,
	department_id UUID,
	status VARCHAR2(30) NOT NULL DEFAULT 'ACTIVE',
	resolution_state VARCHAR2(30),
	source_system VARCHAR2(100),
	active BOOLEAN NOT NULL DEFAULT TRUE,
	mrn_snapshot VARCHAR2(100),
	metadata TEXT,
	created_by UUID,
	updated_by UUID,
	createdAt TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS empi.identity_aliases (
	...
	alias_type VARCHAR2(50) NOT NULL,
