...
CREATE TABLE IF NOT EXISTS clinical.birth_plans (
    ...
    additional_wishes VARCHAR(1000000000),
    delivery_method_notes VARCHAR(1000000000),
    environment_notes VARCHAR(1000000000),
    healthcare_provider VARCHAR(255),
    medical_conditions VARCHAR(1000000000),
    music_preference VARCHAR(255),
    pain_management_notes VARCHAR(1000000000),
    patient_name VARCHAR(255) NOT NULL,
    place_of_birth VARCHAR(255),
    postpartum_notes VARCHAR(1000000000),
    provider_comments VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.consultations (
    ...
    cancellation_reason VARCHAR(1000000000),
    clinical_question VARCHAR(1000000000),
    consultant_note VARCHAR(1000000000),
    current_medications VARCHAR(1000000000),
    follow_up_instructions VARCHAR(1000000000),
    reason_for_consult VARCHAR(1000000000) NOT NULL,
    recommendations VARCHAR(1000000000),
    relevant_history VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.drug_interactions (
    ...
    recommendation VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.education_resource_content_translations (
    ...
    translated_content VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.education_resources (
    ...
    text_content VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.encounter_history (
    ...
    notes VARCHAR(2048),
    extra_fields VARCHAR(1000000000),
    previous_values VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.encounter_note_addenda (
    ...
    content VARCHAR(1000000000) NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.encounter_note_history (
    ...
    content_snapshot VARCHAR(1000000000),
    metadata_snapshot VARCHAR(1000000000),
    template VARCHAR(60),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.encounter_notes (
    ...
    chief_complaint VARCHAR(1000000000),
    data_assessment VARCHAR(1000000000),
    data_evaluation VARCHAR(1000000000),
    data_implementation VARCHAR(1000000000),
    data_objective VARCHAR(1000000000),
    data_plan VARCHAR(1000000000),
    data_subjective VARCHAR(1000000000),
    diagnostic_results VARCHAR(1000000000),
    history_present_illness VARCHAR(1000000000),
    patient_instructions VARCHAR(1000000000),
    physical_exam VARCHAR(1000000000),
    review_of_systems VARCHAR(1000000000),
    summary VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.high_risk_pregnancy_plans (
    ...
    delivery_recommendations VARCHAR(1000000000),
    escalation_plan VARCHAR(1000000000),
    home_monitoring_instructions VARCHAR(1000000000),
    medication_plan VARCHAR(1000000000),
    overall_notes VARCHAR(1000000000),
    risk_notes VARCHAR(1000000000),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.imaging_reports (
    ...
    comparison_studies VARCHAR(1000000000),
    findings VARCHAR(1000000000),
    impression VARCHAR(1000000000),
    lock_reason VARCHAR(255),
    recommendations VARCHAR(1000000000),
    report_title VARCHAR(255),
    technique VARCHAR(1000000000),
    modality VARCHAR(60),
...
CREATE TABLE IF NOT EXISTS clinical.maternal_history (
    ...
    additional_notes VARCHAR(1000000000),
    allergies VARCHAR(1000000000),
    chronic_conditions VARCHAR(1000000000),
    clinical_notes VARCHAR(1000000000),
    complications_details VARCHAR(1000000000),
    contraception_method_prior VARCHAR(255),
    current_medications VARCHAR(1000000000),
    diet_description VARCHAR(1000000000),
    domestic_violence_details VARCHAR(1000000000),
    drug_allergies VARCHAR(1000000000),
    environmental_exposures VARCHAR(1000000000),
    family_history_details VARCHAR(1000000000),
    family_medical_history VARCHAR(1000000000),
    identified_risk_factors VARCHAR(1000000000),
    immunization_notes VARCHAR(1000000000),
    mental_health_conditions VARCHAR(1000000000),
    occupational_hazards_details VARCHAR(1000000000),
    pet_exposure VARCHAR(255),
    previous_pregnancy_complications VARCHAR(1000000000),
    previous_pregnancy_outcomes VARCHAR(1000000000),
    psychosocial_notes VARCHAR(1000000000),
    rubella_immunity VARCHAR(255),
    specialist_referral_reason VARCHAR(1000000000),
    substance_use VARCHAR(1000000000),
    substance_use_details VARCHAR(1000000000),
    support_system VARCHAR(1000000000),
    surgical_history VARCHAR(1000000000),
    travel_history VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.newborn_assessment_alerts (
    ...
    alert_message VARCHAR(1000000000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS clinical.newborn_assessments (
    ...
    apgar_notes VARCHAR(1000000000),
    exam_abdomen VARCHAR(1000000000),
    exam_cardiac VARCHAR(1000000000),
    exam_chest_lungs VARCHAR(1000000000),
    exam_general_appearance VARCHAR(1000000000),
    exam_genitourinary VARCHAR(1000000000),
    exam_head_neck VARCHAR(1000000000),
    exam_musculoskeletal VARCHAR(1000000000),
    exam_neurological VARCHAR(1000000000),
    exam_notes VARCHAR(1000000000),
    exam_skin VARCHAR(1000000000),
    follow_up_notes VARCHAR(1000000000),
    parent_education_notes VARCHAR(1000000000),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.nursing_note_education_entries (
    ...
    education_summary VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.nursing_notes (
    ...
    signed_by_credentials VARCHAR(200),
    signed_by_name VARCHAR(200),
    action_summary VARCHAR(1000000000),
    data_assessment VARCHAR(1000000000),
    data_evaluation VARCHAR(1000000000),
    data_implementation VARCHAR(1000000000),
    data_objective VARCHAR(1000000000),
    ...
    data_subjective VARCHAR(1000000000),
    education_summary VARCHAR(1000000000),
    narrative VARCHAR(1000000000),
    response_summary VARCHAR(1000000000),
    template VARCHAR(60) NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.obgyn_referral_messages (
    ...
    attachments VARCHAR(1000000000),
    body VARCHAR(1000000000) NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.obgyn_referrals (
    ...
    clinical_indication VARCHAR(1000000000),
    history_summary VARCHAR(1000000000),
    midwife_contact_snapshot VARCHAR(1000000000),
    patient_contact_snapshot VARCHAR(1000000000),
    plan_summary VARCHAR(1000000000),
    referral_reason VARCHAR(1000000000) NOT NULL,
    status VARCHAR(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS clinical.patient_chart_section_entries (
    ...
    details_json VARCHAR(1000000000),
    display VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS clinical.patient_problem_history (
    ...
    changed_by_name VARCHAR(200),
    reason VARCHAR(2000),
    snapshot_after VARCHAR(1000000000),
    snapshot_before VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.patient_problems (
    ...
    diagnosis_codes VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.postpartum_care_plans (
    ...
    discharge_safety_notes VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.postpartum_observations (
    ...
    discharge_safety_notes VARCHAR(1000000000),
    education_notes VARCHAR(1000000000),
    psychosocial_notes VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS clinical.prescription_transmissions (
    ...
    payload JSONB,
    status_reason VARCHAR(1000000000),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.procedure_orders (
    ...
    indication VARCHAR(1000000000) NOT NULL,
    pre_procedure_instructions VARCHAR(1000000000),
    procedure_name VARCHAR(255) NOT NULL,
    special_equipment_needed VARCHAR(1000000000),
    status VARCHAR(60) NOT NULL,
    urgency VARCHAR(60) NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.treatment_plan_followups (
    ...
    instructions VARCHAR(1000000000),
    label VARCHAR(255),
    status VARCHAR(60) NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS clinical.visit_education_documentation (
    ...
    discussion_notes VARCHAR(1000000000),
    category VARCHAR(60) NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS governance.security_policy_baselines (
    ...
    summary VARCHAR(1000),
    control_objectives_json VARCHAR(1000000000),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS governance.security_rule_sets (
    ...
    description VARCHAR(1000),
    metadata_json VARCHAR(1000000000),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS hospital.staff (
    ...
    name VARCHAR(500),
    signature_public_key VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS lab.lab_orders (
    ...
    additional_diagnosis_codes VARCHAR(1000000000),
...
CREATE TABLE IF NOT EXISTS lab.lab_test_definitions (
    ...
    description VARCHAR(2048),
    name VARCHAR(255) NOT NULL,
    reference_ranges VARCHAR(1000000000),
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS permission_matrix_audit_events (
    ...
    matrix_json VARCHAR(1000000000),
    metadata_json VARCHAR(1000000000),
    action VARCHAR(60) NOT NULL,
