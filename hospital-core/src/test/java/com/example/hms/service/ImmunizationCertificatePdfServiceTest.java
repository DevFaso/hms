...
class ImmunizationCertificatePdfServiceTest {
    ...
    @Test
    void generate_withMultipleImmunizations_producesValidPdf() throws IOException {
    ...
    @Test
    void generate_emptyList_producesValidPdf() throws IOException {
    ...
    @Test
    void generate_nullVaccineDisplay_fallsToVaccineCode() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
                        .vaccineDisplay(null)
                        .vaccineCode("CVX-207")
    ...
    @Test
    void generate_bothVaccineNamesNull_usesEmDash() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
                        .vaccineDisplay(null)
                        .vaccineCode(null)
    ...
    @Test
    void generate_nullAdministrationDate_usesEmDash() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
    ...
    @Test
    void generate_nullLotNumberAndManufacturer_handlesGracefully() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
    ...
    @Test
    void generate_nullPatientName_handlesGracefully() {
    ...
    @Test
    void generate_doseNumberAndTotalSet_formatsAsXofY() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
                        .vaccineDisplay("HPV")
                        .administrationDate(LocalDate.now())
    ...
    @Test
    void generate_onlyDoseNumberSet_showsDoseOnly() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
    ...
    @Test
    void generate_noDoseFields_usesEmDash() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
    ...
    @Test
    void generate_longVaccineName_truncatedWithEllipsis() {
        List<ImmunizationResponseDTO> immunizations = List.of(
                ImmunizationResponseDTO.builder()
    ...
    @Test
    void generate_manyImmunizations_stopsAtPageBottom() throws IOException {
