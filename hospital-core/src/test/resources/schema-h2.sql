...
-- Clinical prescriptions domain (ensures Hibernate FK creation succeeds during tests)
...
-- EMPI identity management tables (replicated for embedded H2 test profile)
