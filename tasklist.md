...
- [ ] 22. Recall lists + waitlist auto-offer (depends on #11) — 🔨 IN PROGRESS 2026-08-22 (final batch with 24+25). ✅ DECISION MADE 2026-08-22 (user): **the Appointment owns the time** — booking from a slot creates a normal Appointment and stamps the slot BOOKED + appointment_id; slots stay pure capacity inventory; cancelling the appointment releases the slot. Unblocks the dead `appointment_slots.appointment_id` column and `SlotStatus.BOOKED`.
...
- [ ] 24. FHIR bulk `$export` completion (foundation pass never finishes a job); FHIR write/$everything enable-runbook — 🔨 IN PROGRESS 2026-08-22 (final batch with 22+25)
- [ ] 25. Analytics: report builder / scheduled reports; NEWS2/MEWS early-warning scores — 🔨 IN PROGRESS 2026-08-22 (final batch with 22+24)
