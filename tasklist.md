...
- [ ] 19. Microbiology (cultures, susceptibilities) — biggest lab-domain absence — 🔨 PR #472 open 2026-08-22 (`feature/microbiology`, V124: culture reports on lab orders, isolates, S/I/R susceptibility panels; PRELIMINARY→FINAL→CORRECTED lifecycle; positive-culture provider notification; `/microbiology` workbench + patient-detail Micro tab)
- [ ] 20. Note co-sign workflow (student/resident attestation) — 🔨 PR #473 open 2026-08-22 (`feature/note-cosign`, STACKED on #472 — merge #472 first; V125: server-side sign ceremony kills the client-asserted note signature, attending co-sign with self-cosign refusal + staff-at-hospital check, signed-note lock, Clinical Inbox co-sign queue)
